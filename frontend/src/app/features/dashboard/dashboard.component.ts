...
@Component({
  ...
  template: `
    <div class="layout">
      ...
      <!-- MAIN AREA -->
      <div class="main" [class.main-shifted]="sidebarOpen && !isMobile">
  ...
  styles: [`
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Desktop: sidebar can be hidden by sliding */
...
export class DashboardComponent implements OnInit {
  ...
  mainNav: NavItem[] = [
    ...
    { label:'Rooms',     icon:'meeting_room', route:'/dashboard/rooms',    color:'#8B5CF6' },
    { label:'Tenants',   icon:'people',       route:'/dashboard/tenants',  color:'#10B981' },
    { label:'Payments',  icon:'payments',     route:'/dashboard/payments', color:'#F59E0B' },
    { label:'Reports',   icon:'bar_chart',    route:'/dashboard/reports',  color:'#06B6D4' },
  ];
